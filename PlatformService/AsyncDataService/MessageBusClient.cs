    ...
    public class MessageBusClient : IMessageBusClient
    {
        ...
        public MessageBusClient(IConfiguration configuration)
        {
            ...
            var factory = new ConnectionFactory()
            {
                ...
                Port = int.TryParse(_configuration["RabbitMQPort"], out var port) ? port : throw new ArgumentNullException("RabbitMQPort", "RabbitMQPort configuration is missing or invalid")
            };
            try
            {
